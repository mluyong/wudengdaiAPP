<template>
  <div>
       ...
       <div class="myfriend-nav border-bottom">
      ...
      <router-link to="/frienddetail">
       <div class="myfriend-list clearfix">
          <div class="myfriend-list-content clearfix">
            ...
            <div class="myfriend-list-right">
                <div class="clearfix">
                    ...
                    <div class="myfriend-list-number">
                        <p>推荐人 : 赵桐</p>
          ...
          <div class="myfriend-team">
             <ul class="text-size">
                 <li>个人创造积分<span>360</span></li>
                 <li>团队创造积分<span>3600</span></li>
             </ul>    
          </div>
       </div>
    </router-link>
...
.myfriend-nav ul {
  ...
  border-radius: 6px;
  background: linear-gradient(to right, #e7943c 50%, white 50%);
}
.myfriend-nav ul li {
...
.myfriend-nav ul li:nth-child(1) {
  color: white;
}
.myfriend-list,
.myfriend-list-li {
...
.myfriend-list-left img,
.myfriend-list-li img {
  width: 100%;
  height: 100%;
}
.myfriend-list-right {
...
.myfriend-list-right > div:first-child {
  width: 90%;
  float: left;
}
.myfriend-list-id {
...
.myfriend-list-nature {
  float: right;
}
.myfriend-list-nature-right {
  float: right;
  width: 10px;
  margin-top: 20px;
  margin-right: 6px;
}
.myfriend-list-nature-right img {
  width: 100%;
  height: 100%;
}
.myfriend-list-nature span {
  border: 1px solid #e7943c;
  color: #e7943c;
  font-size: 10px;
}
.myfriend-list-number {
  text-align: left;
  margin-top: 20px;
}
.myfriend-list-number p:first-child {
  padding-top: 4px;
}
.myfriend-list-number p {
  font-size: 12px !important;
  color: #666666;
  text-align: left;
}
.myfriend-list-number p span {
  color: #d5590d;
}
